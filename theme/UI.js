...
const styles = StyleSheet.create({
  ...
  headerEyebrow: { color: 'rgba(255,255,255,0.72)', fontSize: 12, fontWeight: '700', letterSpacing: 0.6, textTransform: 'uppercase', marginBottom: 4 },
  headerTitle: { ...type.h1, color: '#fff' },
  headerSubtitle: { color: 'rgba(255,255,255,0.82)', fontSize: 13.5, marginTop: 4, fontWeight: '500' },
  glass: {
